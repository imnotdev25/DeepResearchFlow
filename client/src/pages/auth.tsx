    ...
    <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-slate-50 to-slate-100 dark:from-slate-900 dark:to-slate-800 p-4">
      <div className="w-full max-w-md">
        ...
        <Card className="w-full shadow-lg border-slate-200 dark:border-slate-700">
          <CardHeader className="text-center pb-4">
            ...
            <CardDescription className="text-slate-600 dark:text-slate-400">
              Sign in to continue exploring academic research
            </CardDescription>
          </CardHeader>
          ...
          <CardContent className="space-y-4">
            ...
            <div className="text-center text-sm text-slate-600 dark:text-slate-400">
              ...
              <p className="mt-1">Supports Google, GitHub, X, Apple, and email login</p>
            </div>
        ...
        <div className="text-center mt-6 text-sm text-slate-600 dark:text-slate-400">
          <p>
            New to the platform? No worries! Create your account during the sign-in process.
          </p>
        </div>
      </div>
    </div>
